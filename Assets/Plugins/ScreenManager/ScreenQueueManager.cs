    ...
    public class ScreenQueueManager : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            _subscriptions = new CompositeDisposable
            {
                ...
                EventStreams.Game.Subscribe<EnqueueScreenEvent>(EnqueueScreenHandler),
                ...
                EventStreams.Game.Subscribe<TopScreenChangedEvent>(TopScreenChangedHandler),
                EventStreams.Game.Subscribe<IsOpenedOrPlannedEvent>(IsOpenedOrPlannedHandler),
                EventStreams.Game.Subscribe<IsPlannedEvent>(IsPlannedHandler),
            };
        }
