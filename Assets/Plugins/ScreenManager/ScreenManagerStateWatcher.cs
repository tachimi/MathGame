...
namespace ScreenManager
{
    public class ScreenManagerStateWatcher : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            getOpenedScreensEvent.Publish(EventStreams.Game);
            _openedScreensCount = getOpenedScreensEvent.OpenedScreens.Count;

            _subscriptions = new CompositeDisposable
            {
                EventStreams.Game.Subscribe<ScreenOpeningEvent>(OnScreenOpeningHandler),
                EventStreams.Game.Subscribe<ScreenClosedEvent>(OnScreenClosedHandler),
                EventStreams.Game.Subscribe<GetScreenManagerStateEvent>(GetScreenManagerStateHandler),
            };
        }
